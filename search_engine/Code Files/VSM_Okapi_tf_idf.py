...
def calculate_okapi_tf_idf(d,num_docs,avg_doclen,qf,querylen,avg_querylen):
    ...
    while 1:
        ...
        if not line:
            ...
            for (docid,doclen,tf) in inverted_list:
                ...
                okapi_tf_idf = okapi_tf_document * okapi_tf_query * idf
                d_temp[docid] = okapi_tf_idf
...
fout = open ("sample_okapi_tf_idf_out.txt", "w")

query_file = open ("process_query1.txt", "r")
while 1:
    ...
    for key in query_hashmap.keys():
        ...
        while query_word_counter < len_query:
            ...
            get_dict = calculate_okapi_tf_idf(get_dict,num_docs,avg_doclen,qf,querylen,avg_querylen)        
            query_word_counter += 1
